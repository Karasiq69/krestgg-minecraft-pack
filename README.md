...
> **Distant Horizons убран из пака.** Он крашит игру при заходе на сервер вместе с шейдерами
> (краш 06.08.2026). Кому нужен дальний обзор — ставьте [вручную](https://modrinth.com/mod/distanthorizons)
> и **выключайте шейдеры**, иначе будет падать снова.
>
